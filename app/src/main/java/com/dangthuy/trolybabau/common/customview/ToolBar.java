...
public class ToolBar extends ConstraintLayout {
    ...
    public void setLayoutView(ToolBarType type) {
        if (type.equals(ToolBarType.SETUP)) {
        ...
        } else if (type.equals(ToolBarType.BACK_ADD)) {
            ...
            binding.btnAdd.setVisibility(View.VISIBLE);
            binding.tvTitle.setText(type.getName());
        } else if(type.equals(ToolBarType.BACK_SAVE)) {
            binding.btnBack.setVisibility(View.VISIBLE);
            binding.btnSave.setVisibility(View.VISIBLE);
            binding.tvTitle.setText(type.getName());
            ...
            binding.btnBack.setVisibility(View.VISIBLE);
            binding.tvTitle.setText(type.getName());
        } else if (type.equals(ToolBarType.ADD)) {
            binding.btnAdd.setVisibility(View.VISIBLE);
            binding.btnBack.setVisibility(View.GONE);
            binding.tvTitle.setText(type.getName());
            binding.tvTitle.setOnClickListener(onClickListerer);
        } else if (type.equals(ToolBarType.BACK_TITLE)) {
            binding.btnBack.setVisibility(View.VISIBLE);
            binding.tvTitle.setOnClickListener(onClickListerer);
        }
    }
